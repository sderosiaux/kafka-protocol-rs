...
//!
//! See the schema for this message [here](https://github.com/apache/kafka/blob/trunk/clients/src/main/resources/common/message/DeleteShareGroupOffsetsRequest.json).
...
#[cfg(feature = "broker")]
impl Decodable for DeleteShareGroupOffsetsRequest {
...
impl Message for DeleteShareGroupOffsetsRequest {
...
#[cfg(feature = "broker")]
impl Decodable for DeleteShareGroupOffsetsRequestTopic {
    fn decode<B: ByteBuf>(buf: &mut B, version: i16) -> Result<Self> {
        if version != 0 {
            bail!("specified version not supported by this message type");
        }
...
impl Message for DeleteShareGroupOffsetsRequestTopic {
    const VERSIONS: VersionRange = VersionRange { min: 0, max: 0 };
    const DEPRECATED_VERSIONS: Option<VersionRange> = None;
}

impl HeaderVersion for DeleteShareGroupOffsetsRequest {
