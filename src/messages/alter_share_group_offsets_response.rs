...
//!
//! See the schema for this message [here](https://github.com/apache/kafka/blob/trunk/clients/src/main/resources/common/message/AlterShareGroupOffsetsResponse.json).
...
impl AlterShareGroupOffsetsResponse {
    ...
    /// 
    /// Supported API versions: 0
    pub fn with_responses(mut self, value: Vec<AlterShareGroupOffsetsResponseTopic>) -> Self
    {
...
#[cfg(feature = "client")]
impl Decodable for AlterShareGroupOffsetsResponse {
...
impl Message for AlterShareGroupOffsetsResponse {
...
#[cfg(feature = "client")]
impl Decodable for AlterShareGroupOffsetsResponsePartition {
    fn decode<B: ByteBuf>(buf: &mut B, version: i16) -> Result<Self> {
        if version != 0 {
            bail!("specified version not supported by this message type");
        }
...
impl Message for AlterShareGroupOffsetsResponsePartition {
    const VERSIONS: VersionRange = VersionRange { min: 0, max: 0 };
    const DEPRECATED_VERSIONS: Option<VersionRange> = None;
}
...
impl AlterShareGroupOffsetsResponseTopic {
    ...
    /// 
    /// Supported API versions: 0
    pub fn with_partitions(mut self, value: Vec<AlterShareGroupOffsetsResponsePartition>) -> Self
    {
...
#[cfg(feature = "client")]
impl Decodable for AlterShareGroupOffsetsResponseTopic {
    fn decode<B: ByteBuf>(buf: &mut B, version: i16) -> Result<Self> {
        if version != 0 {
            bail!("specified version not supported by this message type");
        }
...
impl Message for AlterShareGroupOffsetsResponseTopic {
    const VERSIONS: VersionRange = VersionRange { min: 0, max: 0 };
    const DEPRECATED_VERSIONS: Option<VersionRange> = None;
}

impl HeaderVersion for AlterShareGroupOffsetsResponse {
