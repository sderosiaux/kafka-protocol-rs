...
//!
//! See the schema for this message [here](https://github.com/apache/kafka/blob/trunk/clients/src/main/resources/common/message/AlterShareGroupOffsetsRequest.json).
...
#[cfg(feature = "broker")]
impl Decodable for AlterShareGroupOffsetsRequest {
...
impl Message for AlterShareGroupOffsetsRequest {
...
#[cfg(feature = "broker")]
impl Decodable for AlterShareGroupOffsetsRequestPartition {
    fn decode<B: ByteBuf>(buf: &mut B, version: i16) -> Result<Self> {
        if version != 0 {
            bail!("specified version not supported by this message type");
        }
...
impl Message for AlterShareGroupOffsetsRequestPartition {
    const VERSIONS: VersionRange = VersionRange { min: 0, max: 0 };
    const DEPRECATED_VERSIONS: Option<VersionRange> = None;
}
...
#[cfg(feature = "broker")]
impl Decodable for AlterShareGroupOffsetsRequestTopic {
    fn decode<B: ByteBuf>(buf: &mut B, version: i16) -> Result<Self> {
        if version != 0 {
            bail!("specified version not supported by this message type");
        }
...
impl Message for AlterShareGroupOffsetsRequestTopic {
    const VERSIONS: VersionRange = VersionRange { min: 0, max: 0 };
    const DEPRECATED_VERSIONS: Option<VersionRange> = None;
}

impl HeaderVersion for AlterShareGroupOffsetsRequest {
